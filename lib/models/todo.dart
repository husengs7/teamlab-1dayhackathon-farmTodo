...
class Todo {
  ...
  Todo copyWith({
    ...
    return Todo(
      id: this.id,                                  // IDは変更しない
      title: title ?? this.title,                   // 新しいタイトルまたは元のタイトル
      detail: detail ?? this.detail,                // 新しい詳細または元の詳細
      dueDate: dueDate ?? this.dueDate,             // 新しい期日または元の期日
      isCompleted: isCompleted ?? this.isCompleted, // 新しい状態または元の状態
    );
  }
}